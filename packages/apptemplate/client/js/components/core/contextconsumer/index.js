...
function ContextConsumer(Wrapped, valueResolver) {
  return observer(
    class ContextConsumer extends Component {
      constructor() {
        super();
        this.state = {};
        this.constructor.displayName = `ContextConsumer_${Wrapped.name}`;
      ...
      onClick() {
        let { context, params } = this.props;
        if (this.props.onClick) this.props.onClick(context, globals, params);
      }
      ...
      render() {
        ...
        return (
          <Wrapped
            {...this.state.props}
            onContextChange={this.onChange.bind(this)}
            onClick={this.onClick.bind(this)}
            onTextBlur={this.onBlur.bind(this)}
